...
using ElmahCore.Mvc;
using ElmahCore;
using dotnet-rest-api.Api.Filters;
using dotnet-rest-api.Business.Installer;

namespace dotnet-rest-api.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "dotnet-rest-api API", Version = version + "-" + branch});
            });
